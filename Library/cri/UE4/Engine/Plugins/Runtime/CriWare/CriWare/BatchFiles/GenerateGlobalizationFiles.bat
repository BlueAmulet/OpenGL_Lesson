...
if not exist ..\..\Plugins\Runtime\CriWare\BatchFiles\GenerateGlobalizationFiles.bat goto Error_BatchFileInWrongLocation

SET GENERATED_CONFIG=Plugins/Runtime/CriWare/Config/Localization/CriWare
if "%1" == "" (
...
echo.
echo    Repair: Repairs and updates localization data between different versions. It repairs manifests and archives exclusively. Localization resources can be regenerated from repaired/updated manifests and archives as usual.
echo.
